...
function normalizeVehicle(value) {
  ...
  const aliases = {
    ...
    motorcycle_mt: "MT普通二輪車",
    motorcycle_at: "AT普通二輪車",
    motorcycle_small_mt: "MT普通二輪車（小型限定）",
    motorcycle_small_at: "AT普通二輪車（小型限定）",
    "普通自動車（AT）": "AT普通車",
    "普通自動車（MT）": "MT普通車",
    "普通自動車(AT)": "AT普通車",
    "普通自動車(MT)": "MT普通車",
    ...
    "普通自動二輪車(AT)": "AT普通二輪車",
    "普通自動二輪車(MT)": "MT普通二輪車",
    "小型自動二輪車（AT）": "AT普通二輪車（小型限定）",
    "小型自動二輪車（MT）": "MT普通二輪車（小型限定）",
    "小型自動二輪車(AT)": "AT普通二輪車（小型限定）",
    "小型自動二輪車(MT)": "MT普通二輪車（小型限定）"
  };
  return aliases[raw] || raw;
